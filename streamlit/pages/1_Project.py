...
st.markdown("# Project europarl.ai")
st.sidebar.header("Project europarl.ai")
st.write(
    ...
    Mit europarl.ai durchsuchen wir im Hintergrund die Wahlprogramme der Parteien zur Europawahl und die Reden der Parteien im EU-Parlament.
