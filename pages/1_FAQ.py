...
Im Hintergrund nutzen wir eine Retrieval Augmented Generation (RAG) Engine, die Zugriff auf tausende politische Dokumente hat. 
Unser Algorithmus sucht nach den Dokumenten die am relevantesten für deinen Input sind. 
...
In der App findest du nur die sechs größten deutschen Partein, die auch im EU-Parlament vertreten sind.
...
st.write(
    """
Nein, europarl.ai liefert dir eine Zusammenfassung der Positionen der größten Parteien in Deutschland. Es treten jedoch noch sehr viel mehr Kleinstparteien bei der Europawahl an, da es im Gegensatz zur Wahl des Bundestages keine prozentuale Sperrklausel gibt für den Einzug ins EU-Parlament.
...
st.write(
    """
europarl.ai ist unser Abschluss-Projekt für das ["Data Science Retreat"](https://datascienceretreat.com/), ein Bootcamp in Berlin bei dem wir Techniken rund um Data Science, Maschinelles Lernen und Künstliche Intelligenz erlernt haben.
